...
const Trasparant = ({ dataPromis }) => {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6  w-10/12 mx-auto p-10 ">
        {data.map((model) => (
          <div
            className={`shadow-lg p-4 flex flex-col h-full md:p-6 rounded-xl space-y-3 transition-transform duration-300 transform hover:scale-105 hover:shadow-2xl  ${
              model.plan === "Pro"
